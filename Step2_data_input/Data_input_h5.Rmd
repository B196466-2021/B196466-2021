...
```{r}
seu.list <- list(GSM7475112_hbca_v01.seu, GSM7475113_hbca_v02.seu, GSM7475114_hbca_v03.seu, GSM7475115_hbca_v04.seu,GSM7475116_hbca_v05.seu,GSM7475117_hbca_v06.seu,GSM7475118_hbca_v07.seu,GSM7475119_hbca_v08.seu,GSM7475120_hbca_v09.seu,GSM7475121_hbca_v10.seu)

# normalize data and find feature genes
seu.list <- lapply(X = seu.list, FUN = function(x) {
  x <- NormalizeData(x) # normalize data
  x <- FindVariableFeatures(x, selection.method = "vst", nfeatures = 10000) # find 2k feature genes
})
